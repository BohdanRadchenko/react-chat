...
export const testMessage = [
	{id: '00', sender: '43-23-123', message: 'Салам, Брут! Чё, как, уничтожил флот галлов? 🖐🏻 \n Салам, Брут! Чё, как, уничтожил флот галлов? 🖐', time: 'Вчера, в 12:31', read: true},
	{id: '0', sender: '43-23-123', message: 'Салам, Брут! Чё, как, уничтожил флот галлов? 🖐🏻', time: 'Вчера, в 12:31', read: true},
	{id: '1', sender: '43-23-123', message: 'Мы тут недавно войска Ариовиста разбили, чуваки хотели закрепиться на галльских землях, лол 🌝', time: 'Вчера, в 12:31', read: true},
	{id: '2', sender: '1', message: 'Салам, брат Цезарь!', time: 'Вчера, в 12:45', read: true},
	{id: '3', sender: '1', message: 'Всё норм! Флот построили на Лауре. Галлов добили после вашего нападения. Спс! 🔥', time: 'Вчера, в 12:48', read: true},
	{id: '4', sender: '43-23-123', message: 'Да нзч! Ок, держи в курсе.', time: 'Вчера, в 13:12', read: true},
	{id: '5', sender: '1', message: 'Ave Caesar! Morituri te salutant! ☝️', time: 'Вчера, в 13:23', read: true},
	{id: '6', sender: '43-23-123', message: 'picture file', time: 'Вчера, в 12:28', read: true},
	{id: '7', sender: '43-23-123', message: 'Кек. Ты то меня никогда не предашь 😌', time: 'Вчера, в 12:30', read: true},
